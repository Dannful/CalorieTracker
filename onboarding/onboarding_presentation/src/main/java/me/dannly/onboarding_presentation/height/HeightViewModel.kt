package me.dannly.onboarding_presentation.height
...
class HeightViewModel @Inject constructor(
    ...
    private val isHeightValid
        get() = height.toIntOrNull() != null
    ...
    fun onNextClick() {
        viewModelScope.launch {
            val heightNumber = height.toIntOrNull() ?: run {
                _uiEvent.send(
                    UiEvent.ShowMessage(UiText.StringResource(R.string.error_height_cant_be_empty))
                )
                return@launch
            }
