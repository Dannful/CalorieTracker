    ...
    Box(
        ...
        Column(
            ...
            UnitDisplay(
                ...
                amountTextColor = if (value <= goal) MaterialTheme.colors.onPrimary
                else goalExceededColor,
                unitTextColor = if (value <= goal) MaterialTheme.colors.onPrimary
                else goalExceededColor
            )
            Text(
                text = name,
                color = if (value <= goal) MaterialTheme.colors.onPrimary
                else goalExceededColor,
